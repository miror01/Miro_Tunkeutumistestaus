...
1. Valitsin jaksoksi **Erikoistilanteiden asiantuntija, vieraana Juhani Mäkinen | 0x45**, jossa erikoistilanteiden asiantuntija Juhani Mäkinen keskustelee juontajien kanssa muun muassa kriisivalmiudesta sekä kriisialueiden kokemuksistaan Afghanistanissa, Applen laitteiston tietoturvaa sekä haavoittuvuuksia.
...
4. KKO 2003:36 on Korkeikkamn oikeuden ennakkoratkaisu tapauksesta jossa oltiin tunkeuduttu tietojärjestelmään ja aiheutettu vahinkoa. Päätös on määritelty Suomen rikoslain mukaan, ja se kertoo, että pelkkä murto järjestelmiin täyttää rikoksen merkit, vaikkei vahinkoa tehtäisikään.
